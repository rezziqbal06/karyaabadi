...
abstract class SENE_Controller
{
    ...
    public $og_image = SEMEROOT . "media/logo.png";
     ...
     */
    protected function setOGImage($og_image)
    {
    ...
    function convertToMetaDescription($string)
    {
        if (mb_strlen($string) > 157) {
    ...
    /**
     * Return string for Open Graph Image
     * @return string keyword
     */
